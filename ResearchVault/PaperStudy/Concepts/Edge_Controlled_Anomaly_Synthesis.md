...
# 등장 논문
- [[2024_CVPRW_LogicAL|LogicAL]] — 원조. PiDiNet으로 edge 추출, pix2pixHD 기반 edge-to-image generator를 DeepSIM의 TPS warping으로 증강해 학습. Remove/replace/merge 세 조작으로 논리·구조·혼합 이상을 통일된 프레임워크에서 생성.
