...
# 등장 논문
- [[2026_TIP_Unc-SOD|Unc-SOD]] — RPN에 위치 불확실성 예측 branch를 추가할 때 이 방식을 그대로 채택(He et al. 2019 기반). 예측된 σ를 instance-level uncertainty로 집계해 동적 sampling 기준으로 활용하는 것이 이 논문의 확장 지점.
