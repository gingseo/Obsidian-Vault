...
# 등장 논문
- [[2022_CVPR_QueryDet|QueryDet]] — 이 기법의 원조 제안. RetinaNet/FCOS/Faster R-CNN에 적용해 고해상도 P2/P3 연산 비용을 약 74%에서 1%로 줄이면서 정확도 손실 없이 COCO 3.0배, VisDrone 2.3배 추론 속도 향상.
