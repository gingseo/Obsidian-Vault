...
# 등장 논문
- [[2025_TGRS_BAFNet|BAFNet]] — 원조. Dual-Stream Attention Module(DSAM)로 이 개념을 제안. 최고레벨 feature `P4`에서 FPAM을 생성하고 `BPAM = E - FPAM`으로 유도, 각각 dilated convolution 브랜치(rate 3/5/7)로 처리 후 결합.
