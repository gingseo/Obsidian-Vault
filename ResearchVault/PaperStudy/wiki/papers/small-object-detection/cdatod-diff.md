...
원문 요약(Abstract/Introduction/Main Contribution/Conclusion 번역): [[cdatod-diff-source]]
...
### 생각할 점
- <mark style="background: #A6E3A1A6;">RFLA의 Gaussian receptive field 매칭을 명시적으로 확장한다는 점에서, [[gaussian-box-uncertainty-modeling]]/[[position-gaussian-saliency-map]]과 마찬가지로 "Gaussian으로 무언가를 모델링"하는 이 위키의 세 번째 사례 — 다만 이 논문은 박스 좌표나 saliency가 아니라 "샘플링 포인트 자체의 분포"를 모델링한다는 점에서 또 다른 대상을 다룬다.</mark>
