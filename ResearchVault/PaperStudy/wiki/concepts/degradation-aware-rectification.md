...
# 등장 논문
- [[detection-oriented-rectification]] — 이 개념을 최초로 제안. DORA(Detection-Oriented RectificAtion) 프레임워크로 구현하여 degradation basis 기반 학습, MoE 기반 task-oriented rectification, entity reconstruction, self-correction term을 결합해 다양한 detector에 plug-in 형태로 적용. SODA-D/SODA-A/AITOD-R/COCO/VisDrone 5개 벤치마크에서 일관된 성능 향상을 입증.

# 변형/발전
현재는 [[detection-oriented-rectification]] 1편에서만 제안된 개념으로, 이후 변형·확장 사례는 아직 없다.
