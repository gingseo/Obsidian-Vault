...
# 관련 개념
- [[gaussian-box-uncertainty-modeling]] — 둘 다 "객체를 Gaussian으로 모델링"하지만, 전자는 박스 회귀 좌표의 예측 불확실성(NMS/sampling 개선용)을, 이 개념은 위치 기반 saliency/attention(feature enhancement용)을 표현한다는 점에서 용도가 명확히 다르다.
