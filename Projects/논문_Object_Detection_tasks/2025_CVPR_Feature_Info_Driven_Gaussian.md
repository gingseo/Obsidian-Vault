...
- 참고문헌 기반: B. Cao, H. Yao, P. Zhu, Q. Hu, "Visible and clear: Finding tiny objects in difference map" (SR-TOD) [6] (ECCV 2024 / arXiv 2405.11276) — 이 논문이 본문에서 직접 비교·차별화하는 가장 가까운 선행 연구. 이미 [[2024_ECCV_SR-TOD|SR-TOD]]로 위키에 있으므로 재확인 겸 두 접근의 실제 차이를 다시 짚어볼 때 참고.
