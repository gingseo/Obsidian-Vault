...
# 관련 문서
(현재 위키에 직접 비교할 다른 salient-object-detection 논문 노트가 없어 comparison 문서는 아직 만들지 않음. [[2026_Image-and-Vision-Computing_AIMRINet|AIMRINet]]과 함께 향후 2편 이상이 쌓이면 Salient Object Detection 비교 문서 신설을 검토.)
