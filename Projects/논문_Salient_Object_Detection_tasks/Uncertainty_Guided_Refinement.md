...
source: "/Users/GyeongSeo/Workspace/논문_pdf/Salient_Object_Detection/2025_TIP_Uncertainty-Guided-Refinement.pdf"
...
- <mark style="background: #A6E3A1A6;">[[Uncertainty_Masked_Refinement_Attention]]의 ADP(불확실 영역 비율 기반 재귀적 윈도우 분할)는 SOD 외에 dense prediction 전반(depth estimation, anomaly detection의 픽셀 단위 이상 스코어 맵 등)에서 "불확실/이상 영역에만 비용을 쓰는" 동적 추론 패턴으로 재사용할 수 있어 보인다.</mark>
