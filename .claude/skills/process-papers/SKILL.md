---
name: process-papers
description: Projects/논문_pdf/_inbox/와 _issue_paper/에 새로 추가된 논문 PDF를 읽고 ResearchVault/MD_Files/Schema.md 규칙대로 Projects/논문_<Task>_tasks/ 아래 Project Manager task 노트로 반영한다. "raw 정리해줘", "새 논문 처리해줘", "인박스 확인해줘" 같은 요청에 사용.
---
